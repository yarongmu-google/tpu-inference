...
MODEL_IMPL_TYPE=vllm USE_MOE_EP_KERNEL=1 ATTN_BUCKETIZED_NUM_REQS=true ATTN_CUSTOM_NUM_REQS_BUCKETS=8,16,32,64 VLLM_MOE_CHUNK_SIZE=256 vllm serve Qwen/Qwen3-30B-A3B --max-model-len=9216 --max-num-batched-tokens=1024 --max-num-seqs=64 --no-enable-prefix-caching --gpu-memory-utilization=0.88 --tensor-parallel-size=8 --async-scheduling --port=8000 --enable-expert-parallel --block-size=256
